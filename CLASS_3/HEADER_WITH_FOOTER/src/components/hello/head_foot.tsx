      ...
      <div className="container mx-auto p-[30px] bg-gradient-to-b from-pink-500 to-yellow-500 rounded-xl shadow-lg max-w-3xl min-h-[400px] flex flex-col justify-between">
        ...
        <header className="flex justify-between items-center mt-[10px]">
          ...
          <div className="space-x-4">
            <a className="nav-link active text-white uppercase font-bold hover:underline" href="#">Home</a>
            <a className="nav-link text-white uppercase hover:underline font-bold" href="#">About</a>
            <a className="nav-link hover:underline text-white uppercase font-bold" href="#">Skills</a>
            <a className="nav-link text-white hover:underline uppercase font-bold" href="#">Portfolio</a>
            <a className="nav-link hover:underline text-white uppercase font-bold" href="#">Contact</a>
          </div>
        </header>
        ...
        <footer className="flex justify-between space-x-8 items-center pt-4 pb-2 mt-[24px] text-white">
